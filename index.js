...
addGamesToPage(GAMES_JSON);addGamesToPage(GAMES_JSON);
...
function filterUnfundedOnly() {
    ...
    // Log the number of unfunded games for the secret key component
...
function filterFundedOnly() {
    ...
    // Log the number of funded games for the secret key component
...
if (!firstGameContainer || !secondGameContainer) {
    console.error("Containers for top games not found in the DOM.");
}
...
// Ensure the sorting was successful
if (!sortedGames || sortedGames.length === 0) {
    console.error("GAMES_JSON is empty or not sorted correctly.");
}
